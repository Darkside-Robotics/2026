...
public class LEDSubsystem extends SubsystemBase {
  ...
  public LEDSubsystem() {
    ...
    elevatorBrackets[0] = ledBuffer.createView(0, 7);
    elevatorBrackets[1] = ledBuffer.createView(8, 15);
    elevatorBrackets[2] = ledBuffer.createView(16, 23);
    elevatorBrackets[3] = ledBuffer.createView(24, 31);

    utilitysection = ledBuffer.createView(34, 43);
    spacersection = ledBuffer.createView(32, 33);
    spacersection2 = ledBuffer.createView(44, 44);
  ...
  public Command runPattern(LEDPattern pattern) {
    return run(() -> {
      ...
      LEDPattern base = LEDPattern.solid(Color.kPeachPuff);
