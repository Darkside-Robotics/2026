...
public class MoveRightGentlyCmd extends Command {
    ...
    public MoveRightGentlyCmd(SwerveSubsystem swerveSubsystem, long milliseconds,
            TimedRobot robot) {
        this.robot = robot;
    ...
    public void initialize() {
        ...
        swerveSubsystem.drive(0.0, -0.25, 0, false, robot.getPeriod());
    }
    ...
    public void execute() {
        ...
        swerveSubsystem.drive(0, -0.25, 0, false, robot.getPeriod());
    }
