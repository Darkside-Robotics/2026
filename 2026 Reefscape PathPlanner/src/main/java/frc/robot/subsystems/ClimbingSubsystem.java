...
public ClimbingSubsystem(){
 ...
 climbingMotor = new SparkMax(ClimbingConstants.Motor.MotorPort, com.revrobotics.spark.SparkLowLevel.MotorType.kBrushless);
        ...
        climbingMotorConfig.smartCurrentLimit(ClimbingConstants.Motor.CurrentStalledLimit, ClimbingConstants.Motor.CurrentFreeLimit);
...
public void goUp(){
    climbingMotor.set(ClimbingConstants.Motor.Power);
}

public void goDown(){
    climbingMotor.set(-1 * ClimbingConstants.Motor.Power);
}
